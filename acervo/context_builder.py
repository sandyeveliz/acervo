...
_CONTEXT_BUILD_PROMPT = """You are a context preparation assistant. Your job is to prepare a concise, well-organized context summary for another AI assistant that will respond to the user.
